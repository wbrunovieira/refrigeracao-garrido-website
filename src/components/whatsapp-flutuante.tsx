...
export function WhatsappFlutuante() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 grid size-14 place-items-center rounded-full bg-ouro text-azul-950 shadow-[0_12px_36px_-8px] shadow-ouro/70 acao sm:hidden"
    >
