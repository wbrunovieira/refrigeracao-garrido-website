 ...
 * quem dá esse fundo é a própria barra; no rodapé, que é azul-escuro, a marca entra
...
export function Marca({
  ...
  return (
    <span className="inline-flex items-center rounded-xl bg-creme px-6 py-4 ring-1 ring-azul-950/15 shadow-[0_10px_28px_-14px_rgba(0,0,0,.75)]">
      {marca}
    </span>
  );
}
